...
CHANNEL_N = 16
TARGET_SIZE = 48 # This is the internal size of the target after processing
TARGET_PADDING = 8
DEFAULT_FIRE_RATE = 0.5
DEFAULT_BATCH_SIZE = 8
DEFAULT_POOL_SIZE = 1024

# Entropy (Gaussian Noise) settings
DEFAULT_ENTROPY_ENABLED = False
DEFAULT_ENTROPY_STRENGTH = 0.0
MAX_ENTROPY_STRENGTH = 0.1

HISTORY_MAX_SIZE = 200
DEFAULT_RUNNER_SLEEP_DURATION = 0.05
RUNNER_SLEEP_DURATION_TRAINING_ACTIVE = 1 # Slower FPS when training is active (e.g., 5 FPS)
